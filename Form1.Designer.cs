namespace Practica11
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Name = "label1";
            label1.Size = new Size(414, 55);
            label1.TabIndex = 1;
            label1.Text = "Reflejos y Gana";
            label1.Click += label1_Click;
            // 
            // textBox1
            // 
            textBox1.Font = new Font("Consolas", 12F, FontStyle.Regular, GraphicsUnit.Point);
            textBox1.Location = new Point(230, 68);
            textBox1.Margin = new Padding(3, 4, 3, 4);
            textBox1.Multiline = true;
            textBox1.Name = "textBox1";
            textBox1.Size = new Size(749, 199);
            textBox1.TabIndex = 2;
            textBox1.Text = "Bienvenido al juego\r\n\r\nPon a prueba tus reflejos, presiona el color que aparezca\r\ndebajo  del coche,evita tener más de 5 coches en la fila para no perder.\r\n\r\nPresiona START cuando estés listo\r\n";
            // 
            // Rojo
            // 
